...
$country=$_POST['countries'];
       ...
       $y=$yummy->results[0]->geometry->lng;
        if($output!==0){
                ...
                $url8="http://newsapi.org/v2/top-headlines?country=".$countryCode."&apiKey=3f1df78dbaca4be8a6aef49c8730448d";
                $url9="https://covid19.mathdro.id/api/countries/".$countryCode;

                $nodes = array($url1, $url2, $url3, $url4, $url5, $url6, $url7, $url8, $url9);
