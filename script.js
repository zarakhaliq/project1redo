...
$(document).ready(function () {
  if (navigator.geolocation) {
    navigator.geolocation.getCurrentPosition(function (position) {
      ...
      if (localStorage.getItem("borders") === null) {
        $.ajax({
          type: "POST",
          url: "capitalCity.php",
          data: {
          ...
          success: function (data) {
            ...
            var latitude = parsedData.latlng[0];
            var longitude = parsedData.latlng[1];
            var nativeName = parsedData.nativeName;
            var Region = parsedData.region;
        ...
        var nativeName = localStorage.getItem("nativeName");
        var Region = localStorage.getItem("Region");
        var marker = L.marker([latitude, longitude], {
          icon: customIcon,
          draggable: "true",
        })
          .bindPopup(nativeName + ", " + Region)
          .openPopup()
          .addTo(map);
