    ...
    if (localStorage.getItem("city") !== selectedCountry) {
      $.ajax({
        ...
        success: function (res, status) {
          ...
          if (JSONdata7.articles[0]) {
            console.log(JSONdata7.articles);
            function NewsArticles() {
              ...
              for (var i = 0; i < 6; i++) {
                ...
                if (Articles[i].author == null) {
                  $("#titles").append("<p> Written by Unknown </p>");
                } else {
                  $("#titles").append(
      ...
      var recovered = localStorage.getItem("recovered", recovered);
      var confirmed = localStorage.getItem("confirmed", confirmed);
      var deaths = localStorage.getItem("deaths", deaths);
      var lastUpdate = localStorage.getItem("lastUpdate", lastUpdate);
      $("#borders").empty();
